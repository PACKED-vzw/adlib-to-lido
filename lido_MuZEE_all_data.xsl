        ...
        <xsl:template match="/">
            ...
            <lido:lidoWrap xmlns:lido="http://www.lido-schema.org"
                ...
                <lido:lido>
                    ...
                    <lido:objectPublishedID lido:source="Mu.ZEE" lido:type="WorkPID" lido:label="WorkPID">[WorkPID]</lido:objectPublishedID>
                    <lido:descriptiveMetadata xml:lang="nl-NL"> 
                        ...
                        <lido:objectIdentificationWrap>
                            ...
                            <lido:repositoryWrap>
                                ...
                                <lido:repositorySet>
                                    <lido:repositoryName>
                                        <lido:legalBodyID lido:type="ISIL">[ISILnummer]</lido:legalBodyID>
                                        <lido:legalBodyName>
                                            <lido:appellationValue>Mu.ZEE</lido:appellationValue>
                                        </lido:legalBodyName>
                                    </lido:repositoryName>
                                ...
                                <xsl:for-each select="./Loan_out">
                                    ...
                                    <lido:eventSet>
                                        ...
                                        <lido:event>
                                            ...
                                            <!-- default waarde exhibition -->
                                            <lido:eventType><lido:term>exhibition</lido:term></lido:eventType>
                                            <!-- titel van de tentoonstelling wordt niet in Loans ingevuld bij MuZEE-->
                                            <lido:eventName>
                                            ...
                                            <xsl:if test="loan.out.contract.period.start or loan.out.contract.period.end">
                                                <lido:eventDate>
                                                    <lido:displayDate><xsl:value-of select="./loan.out.contract.period.start"/>;<xsl:value-of select="./loan.out.contract.period.end"/></lido:displayDate>
                                                    <lido:date>
                                                        <lido:earliestDate></lido:earliestDate>
                                                        <lido:latestDate></lido:latestDate>
                                                    </lido:date>
            ...
            Bij MuZEE worden 'treatment' en 'conservator' velden verder niet ingevuld
            -->
