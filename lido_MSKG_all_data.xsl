        ...
        <xsl:template match="/">
            ...
            <lido:lidoWrap xmlns:lido="http://www.lido-schema.org"
                ...
                <xsl:for-each select="./adlibXML/recordList/record">
                    <lido:lido>
                        ...
                        <lido:objectPublishedID lido:source="MSKG" lido:type="WorkPID" lido:label="WorkPID">[WorkPID]</lido:objectPublishedID>
                        <lido:descriptiveMetadata xml:lang="nl-NL">
                            ...
                            <lido:objectIdentificationWrap>
                                ...
                                <lido:repositoryWrap>
                                    ...
                                    <lido:repositorySet>
                                        <lido:repositoryName>
                                            <lido:legalBodyID lido:type="ISIL">BE-GET03</lido:legalBodyID>
                                            <lido:legalBodyName>
                                                <lido:appellationValue>Museum voor Schone Kunsten Gent (MSKG)</lido:appellationValue>
                                            </lido:legalBodyName>
                                        </lido:repositoryName>
            ...
            -->        
                            ...
                            <!-- een exhibition event voor elke Exhibition/exhibition node. resterende gegevens binnen de Exhibition node worden genegeerd. -->
                                    ...
                                    <xsl:for-each select="./Exhibition">
                                        <lido:eventSet>
                                            <lido:event>
                                                ...
                                                <lido:eventID lido:type="local reference number"><xsl:value-of select="./exhibition/reference_number"/></lido:eventID>
                                                <lido:eventID lido:type="local catalogue number"><xsl:value-of select="./exhibition.catalogue_number"/></lido:eventID>
                                ...
                                <!-- een exhibition event voor elke loan_out node. Bij MSKGent worden deze velden niet gebruikt. 
                                Bruiklenen worden in aparte Excel lijsten bijgehouden -->
            ...
            eventDescriptionSet   Condition/condition.notes
                                ...
                                treatment en conservation velden worden bijna niet ingevuld
                                -->
                            ...
                            <lido:objectRelationWrap>
                                <!-- max 15 codes, niet opgelost: hoe term meenenem: veld content.classification.code, content.motif.general en content.motif.specific zijn niet 
                                gestructureerd uit Adlib van MSKG meegekomen en content.classification.code's gelden voor general en voor specific. Maar er is geen
                            mogelijkheid om te weten hoeveel 'general's er zijn voor dat 'specific' termen beginnen. vb code 1 = general 1, code 2 = general 2, 
                            code 3 = specific 1 enz. Dit kan niet worden opgevangen met de [1] manier-->
                                <lido:subjectWrap>
                                    <xsl:if test="./content.classification.code[1]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[1]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[2]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[2]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[3]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[3]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[4]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[4]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[5]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[5]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[6]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[6]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[7]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[7]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[8]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[8]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[9]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[9]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[10]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[10]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[11]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[11]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[12]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[12]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[13]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[13]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    ...
                                    <xsl:if test="./content.classification.code[14]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[14]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
                                    </xsl:if>
                                    <xsl:if test="./content.classification.code[15]">   
                                        <lido:subjectSet>
                                            <lido:subject>
                                                <lido:subjectConcept>
                                                    <lido:conceptID lido:type="extern" lido:label="Iconclass"><xsl:value-of select="./content.classification.code[15]"/></lido:conceptID>
                                                    <lido:term></lido:term>
                                                </lido:subjectConcept>
                                            </lido:subject>
                                        </lido:subjectSet>
